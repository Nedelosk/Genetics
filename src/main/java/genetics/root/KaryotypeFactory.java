...
public class KaryotypeFactory implements IKaryotypeFactory {
	...
	@Override
	public IKaryotypeBuilder createKaryotype(String uid, IChromosomeType templateType, Function<IKaryotype, IAlleleTemplate> speciesType) {
		return new Karyotype.Builder(uid, templateType, speciesType);
	}

	@Override
	public <T extends Enum<T> & IChromosomeType> IKaryotype createKaryotype(String uid, Class<? extends T> enumClass, Function<IKaryotype, IAlleleTemplate> defaultTemplate) {
